...
class _UserDashBoardScreenState extends State<UserDashBoardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: const NavBar(),
      appBar: AppBar(title: const Text('Animal Rescue')),
      body: SafeArea(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            Text('Report Details', style: theme.textTheme.titleMedium),
            const SizedBox(height: 20),
